...
namespace Cunifymax\VirtualPages;

/*
  Plugin Name: Cunifymax Virtual Pages
...
add_filter('the_permalink', function( $plink ) {
    ...
    if (
            $wp_query->is_page && isset($wp_query->virtual_page) && $wp_query->virtual_page instanceof Page && isset($post->is_virtual) && $post->is_virtual
    ) {
